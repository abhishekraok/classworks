# -*- coding: utf-8 -*-
"""
Created on Sat Apr 26 23:55:13 2014

@author: Abhishek
Finding the optimal parameter C and Gamma for SVClassifier 
Dataset EEG Eye
"""
import numpy as np
import pylab as pl
...
Y = X[:5000,-1]           #y is the last column of data set
X = X[:5000,:-1]          #X is all of the data except last column
#iris = load_iris()
#X = iris.data
#Y = iris.target
# dtaset for decision function visualization
X_2d = X[:, :2]
#X_2d = X_2d[Y > 0]
Y_2d = Y #[Y > 0]
#Y_2d -= 1
